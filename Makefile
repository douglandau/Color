...
SYS_LIBRARIES = -lm  $(XMLIB) $(XMULIB) $(XTOOLLIB) $(XLIB)

DEPLIBS = $(DEPXMLIB) $(DEPXMULIB) $(DEPXTOOLLIB) $(DEPXLIB)

SRCS =  color.c rgb.c log.c cmap.c error.c
OBJS =  color.o rgb.o log.o cmap.o error.o
...
install:: color
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  color $(DESTDIR)$(BINDIR)/color

install.man:: color.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) color.man $(DESTDIR)$(MANDIR)/color.$(MANSUFFIX)
